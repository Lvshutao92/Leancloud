...
@interface LiaotianAddViewController ()<UITextViewDelegate>
@property(nonatomic,strong)UITextView *textview;

@end

@implementation LiaotianAddViewController
...
- (void)clickSave {
    if (self.textview.text.length > 0) {
        ...
        AVObject *todoFolder = [[AVObject alloc] initWithClassName:@"LiaoTian"];// 构建对象
        ...
        [todoFolder saveInBackgroundWithBlock:^(BOOL succeeded, NSError * _Nullable error) {
            if (succeeded) {
                ...
                NSNotification *notification =[NSNotification notificationWithName:@"change" object:nil userInfo:dict];
